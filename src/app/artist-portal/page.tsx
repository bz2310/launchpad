        ...
        {activeGoals.length > 0 ? (
          ...
          <div className="new-goal-card">
            <div className="new-goal-content">
              ...
              <div className="new-goal-text">
                <h3>Create a New Goal</h3>
                <p>Rally your fans around a milestone with exclusive unlocks and rewards</p>
              </div>
            </div>
            <Link href="/artist-portal/goals/create" className="new-goal-btn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <line x1="12" y1="5" x2="12" y2="19" />
                <line x1="5" y1="12" x2="19" y2="12" />
              </svg>
