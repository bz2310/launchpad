...
export const artists: Record<string, Artist> = {
  ...
  artist_002: {
    ...
    activeGoal: {
      id: 'goal_gaga_001',
      title: 'Mayhem World Tour Fund',
      description: 'Help fund exclusive fan experiences at tour stops',
      currentValue: 67500,
      targetValue: 100000,
      metric: 'supporters',
      color: '#ff69b4',
  ...
  artist_003: {
    ...
    activeGoal: {
      id: 'goal_weeknd_001',
      title: 'After Hours Experience',
      description: 'Unlock exclusive visuals and behind-the-scenes content',
      currentValue: 52000,
      targetValue: 75000,
      metric: 'pre-saves',
      color: '#ff0000',
  ...
  artist_004: {
    ...
    name: 'The Strokes',
    handle: '@thestrokes',
    avatar: 'https://i.scdn.co/image/ab67616100005174c3b137793230f4043feb0089',
    verified: true,
    ...
    activeGoal: {
      id: 'goal_strokes_001',
      title: 'New Album Recording Fund',
      description: 'Help us book studio time for the next album',
      currentValue: 45000,
      targetValue: 80000,
  ...
  artist_005: {
    ...
    name: 'Weezer',
    handle: '@weezer',
    avatar: 'https://i.scdn.co/image/ab676161000051743cd35451daa1b690cfbbb2d4',
    verified: true,
    ...
    activeGoal: {
      id: 'goal_weezer_001',
      title: 'Blue Album 30th Anniversary',
      description: 'Special remastered edition with unreleased demos',
      currentValue: 38000,
      targetValue: 50000,
      metric: 'pre-orders',
      color: '#0066cc',
...
export const chatConversations: ChatConversation[] = [
  ...
  },
  {
    ...
    recipientAvatar: 'https://i.scdn.co/image/ab67616100005174c3b137793230f4043feb0089',
  ...
  },
  {
    ...
    recipientAvatar: 'https://i.scdn.co/image/ab676161000051743cd35451daa1b690cfbbb2d4',
