...
export const artists: Record<string, Artist> = {
  ...
  artist_004: {
    ...
    socialLinks: {
      spotify: 'https://open.spotify.com/artist/isti',
      instagram: 'https://www.instagram.com/istimusic',
      soundcloud: 'https://soundcloud.com/isti',
    },
    momentum: {
      current: 4100,
      target: 5000,
    ...
    badges: [
      { id: 'rising', name: 'Rising Star', icon: 'trending-up', color: '#f97316' },
      { id: 'independent', name: 'Independent', icon: 'edit', color: '#06b6d4' },
      { id: 'playlist', name: 'Playlist Featured', icon: 'music', color: '#1DB954' },
    ],
  },
  artist_005: {
    id: 'artist_005',
    ...
    socialLinks: {
      spotify: 'https://open.spotify.com/artist/prettybleak',
      instagram: 'https://www.instagram.com/prettybleak',
      tiktok: 'https://www.tiktok.com/@prettybleak',
    },
    momentum: {
      current: 2800,
      target: 5000,
    ...
    badges: [
      { id: 'viral', name: 'Viral Hit', icon: 'zap', color: '#ff4757' },
      { id: 'rising', name: 'Rising Star', icon: 'trending-up', color: '#f97316' },
      { id: 'independent', name: 'Independent', icon: 'edit', color: '#06b6d4' },
    ],
  },
